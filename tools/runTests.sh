...
# Function to write a .env file in tools/testing-docker
# This is read by docker-compose and vars defined here are
# used in tools/testing-docker/docker-compose.yml
...
TEST_FILE=${1}
if [ -n "${1}" ]; then
    TEST_FILE="public/typo3conf/ext/templavoilaplus/${1}"
fi
    ...
    functional)
        ...
        case ${DBMS} in
            ...
            postgres)
                ...
                ;;
            sqlite)
                # sqlite has a tmpfs as .Build/public/typo3temp/var/tests/functional-sqlite-dbs/
