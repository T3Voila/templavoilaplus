...
This manual for TemplaVoilà! Plus v8 isn't complete like it was never for TemplaVoilà.
...
So this document maybe unhelpful for newbies. But we will update this documentation
from time to time. If you find something, which isn't clear please fill in an issue
report on the `Project page <https://github.com/T3Voila/templavoilaplus/issues>`_.
