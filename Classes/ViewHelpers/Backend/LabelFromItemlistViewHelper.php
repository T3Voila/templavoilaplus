 ...
 */
class LabelFromItemlistViewHelper extends AbstractViewHelper
{
    /**
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('key', 'string', 'Key in option list', true);
    }
    ...
    {
        return BackendUtility::getLabelFromItemlist($this->arguments['table'], $this->arguments['fieldName'], $this->arguments['key']);
    }
}
