 ...
 * TYPO3 v8+ code only using PHP7
 * Source is taken from TYPO3 v8/v9 \TYPO3\CMS\Backend\Controller\FormFlexAjaxController
 */
class FormFlexAjaxController9 extends \TYPO3\CMS\Backend\Controller\FormFlexAjaxController
{
    /**
    ...
    public function containerAdd(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $flexFormCurrentLanguage = $queryParameters['flexFormCurrentLanguage'];
        ...
        $formData['flexFormDataStructureArray'] = $dataStructure['sheets'][$flexFormSheetName][$flexFormCurrentLanguage]['ROOT']['el'][$flexFormFieldName]['children'][$flexFormContainerIdentifier];
        ...
        $formData['flexFormFormPrefix'] = '[data][' . $flexFormSheetName . '][' . $flexFormCurrentLanguage . ']' . '[' . $flexFormFieldName . ']' . '[el]';
        ...
        $formData['parameterArray']['fieldConf']['config']['ds']['meta'] = $dataStructure['meta'];
